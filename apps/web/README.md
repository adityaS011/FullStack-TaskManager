...
src/components/tasks    Dashboard, task details, attachments, activity timeline, filters, drawer form, realtime hook
...
- Task titles open `/tasks/[id]`, which shows task metadata, attachments, and activity history.
